...
<p align="center">
  <img src="https://github.com/ftucciarone/eOrca1_AGRIF/blob/main/figures/med-Orca_global.png" width="300" height="400"/>
  <img src="https://github.com/ftucciarone/eOrca1_AGRIF/blob/main/figures/med-Orca_local.png" width="300" height="400"/>
</p>
...
> export SRCSDIR=$HOME/nemo-deps/sources
> export INSTDIR=$HOME/nemo-deps/installs
> export XIOSDIR=$HOME/nemo-deps/XIOS/xios-trunk
> export WORKDIR=$HOME/nemo-AGRIF
> ```
> so that we can refer to the same directory tree.
